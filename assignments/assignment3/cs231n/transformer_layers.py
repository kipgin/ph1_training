...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, embed_dim, dropout=0.1, max_len=5000):
        ...
        div_term = torch.exp(torch.arange(0, embed_dim, 2) * -(math.log(POS_FACTOR) / embed_dim))
...
class PatchEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        ############################################################################
        patches = x.reshape(N, C, H // self.patch_size, self.patch_size, W // self.patch_size, self.patch_size)
